...
anova(penguin.model.basel,penguin.model.mine)

#F-test between initial model and our final model
anova(penguin.model.initial,penguin.model.mine)
...
```{r,fig.dim = c(10,10), echo =True}
library(sfsmisc)
TA.plot( penguin.model.mine, fit = fitted(penguin.model.mine), res = residuals(penguin.model.mine), labels = "*" )
